...
xdescribe('po-page-detail:', () => {
  ...
  it('should create <name> component', async () => {
    ...
    const tree = await runner
      .runSchematicAsync('po-page-detail', { ...componentOptions, name: componentName }, appTree)
      .toPromise();
    if (!tree) return;
  ...
  it('should create <name> component and <name> module', async () => {
    ...
    const tree = await runner.runSchematicAsync('po-page-detail', options, appTree).toPromise();
    if (!tree) return;
    const files: Array<string> = tree.files;
  ...
  it('should generate component in path informed', async () => {
    ...
    const options = { ...componentOptions, name: 'customers', createModule: true };
    await runner.runSchematicAsync('po-page-detail', options, appTree).toPromise();
    ...
    const treePath = await runner.runSchematicAsync('po-page-detail', optionsPath, appTree).toPromise();
