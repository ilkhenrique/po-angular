...
xdescribe('po-page-dynamic-detail:', () => {
  ...
  it('should create <name> component', async () => {
    ...
    const tree = await runner
      .runSchematicAsync('po-page-dynamic-detail', { ...componentOptions, name: componentName }, appTree)
      .toPromise();
  ...
  it('should create <name> component and <name> module', async () => {
    ...
    const tree = await runner.runSchematicAsync('po-page-dynamic-detail', options, appTree).toPromise();if (!tree) throw new Error("tree is undefined");
  ...
  it('should generate component in path informed', async () => {
    ...
    const options = { ...componentOptions, name: 'customers', createModule: true };
    await runner.runSchematicAsync('po-page-dynamic-detail', options, appTree).toPromise();
    ...
    const treePath = await runner.runSchematicAsync('po-page-dynamic-detail', optionsPath, appTree).toPromise();
