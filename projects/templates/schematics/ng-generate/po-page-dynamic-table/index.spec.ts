...
xdescribe('po-page-dynamic-table:', () => {
  ...
  beforeEach(async () => {
    appTree = await runner.runExternalSchematicAsync('@schematics/angular', 'workspace', workspaceOptions).toPromise();if (!appTree) throw new Error("appTree is undefined");if (!appTree) throw new Error("appTree is undefined");
  ...
  it('should create <name> component', async () => {
    ...
    const tree = await runner
      .runSchematicAsync('po-page-dynamic-table', { ...componentOptions, name: componentName }, appTree)
      .toPromise();
  ...
  it('should create <name> component and <name> module', async () => {
    ...
    const tree = await runner.runSchematicAsync('po-page-dynamic-table', options, appTree).toPromise();if (!tree) throw new Error("tree is undefined");
  ...
  it('should generate component in path informed', async () => {
    ...
    const options = { ...componentOptions, name: 'customers', createModule: true };
    await runner.runSchematicAsync('po-page-dynamic-table', options, appTree).toPromise();
    ...
    const treePath = await runner.runSchematicAsync('po-page-dynamic-table', optionsPath, appTree).toPromise();
