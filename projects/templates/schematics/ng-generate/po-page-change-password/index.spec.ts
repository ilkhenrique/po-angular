...
xdescribe('po-page-change-password:', () => {
  ...
  it('should create <name> component', async () => {
    ...
    const tree = await runner
      .runSchematicAsync('po-page-change-password', { ...componentOptions, name: componentName }, appTree)
      .toPromise();
  ...
  it('should create <name> component and <name> module', async () => {
    ...
    const tree = await runner.runSchematicAsync('po-page-change-password', options, appTree).toPromise();if (!tree) throw new Error("tree is undefined");
  ...
  it('should generate component in path informed', async () => {
    ...
    const options = { ...componentOptions, name: 'customers', createModule: true };
    await runner.runSchematicAsync('po-page-change-password', options, appTree).toPromise();
    ...
    const treePath = await runner.runSchematicAsync('po-page-change-password', optionsPath, appTree).toPromise();
